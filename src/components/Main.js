...
class Main extends Component {
    ...
    fetchSatellite =setting =>{
        //step1: get setting
        //step2. send the req to the server and display loading
        //step3: get response from the server 
        //      case 1. succuss -> update satList, disable/unmount loading icon
        //      case 2: fail -> inform users, unmount loading icon
